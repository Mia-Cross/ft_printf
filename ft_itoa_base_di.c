...
/*   Updated: 2019/12/10 18:45:14 by lemarabe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int		get_size(int s_count, t_param *data, int nbr)
{
	int	size;
...
static long		put_sign_and_p(char *str, int nbr, t_param *data, int s_count)
{
	long	l;
	int		i;
	int		p;
...
static int		nbr_len(int nbr, int base_len, t_param *data)
{
	int		i;
	long	p;
...
static char		*print_nbr(char *str, int nbr, char *base, t_param *data)
{
	int		i;
	int		s_count;
	int		base_len;
